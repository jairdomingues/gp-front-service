...
import { Category } from '../cruds/category/category.model';
...
export class ShopService {
  ...
  public getProducts(partnerId): Observable<Product[]> {
    if (typeof  partnerId === "undefined") {
      ...
      return this.productService.getAllProductsPartner(partnerId)
      .pipe(
        delay(500),
        map((data: Product[]) => {
          this.products = data;
  ...
  public getFilteredProduct(partnerId: any, filterForm: FormGroup): Observable<Product[]> {
    return combineLatest(
      this.getProducts(partnerId),
