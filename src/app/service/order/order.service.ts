...
export class OrderService {
  ...
  createSalesOrder(salesOrderRequest): Observable<any> {
    return this.http.post<any>(this.apiUrl+'orders', salesOrderRequest, httpOptions).pipe(
      tap((salesOrderResponse: any) => console.log(`sales order created id=${salesOrderResponse.id}`)),
